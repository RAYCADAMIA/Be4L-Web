...
export const PersistentLogo: React.FC<PersistentLogoProps> = ({ viewState, expanded }) => {
    ...
    return (
        ...
        >
            ...
            >
                {/* 'Be' moves naturally */}
                <motion.span layout className="brand-text-dusk !pr-0 leading-none">Be</motion.span>
                ...
                <div className="relative flex items-center justify-center">
                    ...
                    <motion.span
                        ...
                        className="brand-text-dusk !pr-0 leading-none"
                    >4</motion.span>
                    ...
                    <motion.span
                        ...
                        className="overflow-hidden whitespace-nowrap brand-text-dusk !pr-0 leading-none"
                    >For</motion.span>
                </div>
                ...
                <div className="flex items-center relative gap-0">
                    <div className="flex items-center">
                        <motion.span layout className="brand-text-dusk !pr-0 leading-none">L</motion.span>
                        <motion.span
                            animate={{
                                width: expanded ? "auto" : 0,
                                opacity: expanded ? 1 : 0
                            }}
                            className="overflow-hidden brand-text-dusk flex leading-none !pr-0"
                        >
                    ...
                    <motion.div
                        ...
                        className={`absolute left-full ml-4 md:ml-8 border border-white/10 bg-white/5 rounded-lg md:rounded-2xl px-2 md:px-4 py-1 md:py-2 text-[10px] md:text-xl font-black uppercase tracking-[0.2em] brand-text-dusk whitespace-nowrap`}
                    >
                        BETA
                    </motion.div>
                </div>
